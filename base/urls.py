...
urlpatterns = [
    ...
    path(
        "actualizar_profile/<int:pk>/",
        views.actualizar_profile,
        name="actualizar_profile",
    ),
    ...
    path(
        "comentario-update/<int:pk>/", views.comentario_update, name="comentario_update"
    ),
    path(
        "comentario-delete/<int:pk>", views.comentario_delete, name="comentario_delete"
    ),
    # url para equipos
    ...
    path(
        "enviar_invitacion/<int:pk>/", views.enviar_invitacion, name="enviar_invitacion"
    ),
    path(
        "aceptar_invitacion/<uuid:token>/",
